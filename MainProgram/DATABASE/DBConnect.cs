...
using MainProgram.GROUP;
using MainProgram.USER;

namespace MainProgram.DATABASE
{
    static class DbConnect
    {
        ...
        static public List<CHAT.Data> GetAllChats(int groupId)
        {
            //  Define output:
            List<CHAT.Data> output = new List<CHAT.Data>();
                ...
                using (MySqlDataReader reader = command.ExecuteReader())
                {
                    ...
                    if (reader.HasRows)
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            output.Add(new CHAT.Data(chatId, chatName, chatDescription));
                        }
                    }
                }
            }
        ...
        /// </summary>
        /// <returns></returns>
        static public List<USER.Data> GetAllUsers()
        {
            //Define output:
            List<USER.Data> output = new List<USER.Data>();
            try
            {
                if (_connection.State != System.Data.ConnectionState.Open)
                {
                ...
                using (MySqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        output.Add(new USER.Data(userId, name, surname, email, region, department, phonenumber, quote, portfolio, photolink, adres, gender, type, dob, img));
                    }
                }
            }
            catch (Exception ex)
        ...
        /// </summary>
        /// <returns></returns>
        static public List<GROUP.Data> GetAllGroupInfo()
        {
            //Define output
            List<GROUP.Data> output = new List<GROUP.Data>();
        ...
        /// <returns></returns>
        static public List<GROUP.Data> GetGroups(int userId)
        {
            //Define output:
            List<GROUP.Data> output = new List<GROUP.Data>();
            ...
            try
            {
                ...
                using (MySqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        output.Add(new GROUP.Data(groupId, groupName, groupDescription));
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        static public List<CHAT.Message> GetMessages(int chatId)
        {
            //Define output:
            List<CHAT.Message> output = new List<CHAT.Message>();
            ...
            try
            {
                ...
                using (MySqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        output.Add(new CHAT.Message(Convert.ToInt32(reader["UserID"]), Convert.ToString(reader["Message"])));
                    }
                }
            }
            catch (Exception ex)
        ...
        static public List<USER.Data> GetAllUsers(int clientId)
        {
            //Define output:
            List<USER.Data> output = new List<USER.Data>();
            try
        ...
        static public void UpdateUserInformation(string username, string usersurname, string useremail, string userregion, string userdepartment, string userPhoneNumber, string userQuote, string userPortfolio, string photoLink, string userAdres, int userId)
        {
            try
            {
                if (_connection.State != System.Data.ConnectionState.Open)
                ...
                //incomplete query 
                string query = "UPDATE users SET UserName= @username,UserSurname = @userSurname, UserEmail = @userEmail, UserRegion = @userRegion, UserDepartment = @userDepartment, UserPhoneNumber = @userPhoneNumber, UserQuote = @userQuote, UserPortfolio = @userPortfolio, UserPhotoLink = @photoLink, UserAdres = @userAdres WHERE  UserID = @UserId";
                //defining parameters
                MySqlParameter param1 = new MySqlParameter();
        ...
        static public void UpdateUserInformation(string username, string usersurname, string useremail, string userregion, string userdepartment, string userPhoneNumber, string userQuote, string userPortfolio, string photoLink, string userAdres, int userId, byte[] userProfilePicture)
        {
            try
            {
                if (_connection.State != System.Data.ConnectionState.Open)
                ...
                //incomplete query 
                string query = "UPDATE users SET UserName= @username,UserSurname = @userSurname, UserEmail = @userEmail, UserRegion = @userRegion, UserDepartment = @userDepartment, UserPhoneNumber = @userPhoneNumber, UserQuote = @userQuote, UserPortfolio = @userPortfolio, UserPhotoLink = @photoLink, UserAdres = @userAdres, UserProfilePicture = @UserProfilePicture WHERE  UserID = @UserId";
                //defining parameters
                MySqlParameter param1 = new MySqlParameter();
                param1.ParameterName = "@username";
                param1.Value = username;
